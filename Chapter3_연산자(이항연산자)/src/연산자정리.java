 ...
 *  => 좌선 예매 => 영화, (맛집, 도서관)
 *  
 *  => 형변환 연산자 : 자동 처리, 필요할 때 강제 형변환(숫자 => 정수, 문자, 실수)
 *  => 클래스 형변환(*******)
...
public class 연산자정리 {
	...
	public static void main(String[] args) {
		...
		Scanner scan = new Scanner(System.in); //키보드 입력값을 받을 준비 => 클래스는 메모리에 저장시에 반드시 new 이용
		// 그러면 JVM에서 저장 메모리 크기를 확인하고 배치해줌. => heap이라는 곳에 저장되고 관리는 GC가 함.  
		...
		System.out.println("국어점수:"+kor);// void java.io.PrintStream.Println
		System.out.println("영어점수:"+eng);
		System.out.println("수학점수:"+math);
		System.out.println("총점:"+total);
		System.out.printf("%.2f\n",avg);
		System.out.println(tempt>=60?"Pass":"Fail");//
	}
